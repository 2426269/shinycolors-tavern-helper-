import { generateAndValidate } from './llm_utils';
...
async function testValidation() {
  ...
  // 我们期望 validateEngineData 会报错 (因为 logic_chain 是必填的)，
  // 然后 generateAndValidate 会自动把错误发回给 LLM，
  // LLM 应该在第二次尝试中补上 logic_chain。

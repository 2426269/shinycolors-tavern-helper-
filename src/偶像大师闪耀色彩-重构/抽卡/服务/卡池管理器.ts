...
import type { GachaPool, PoolStats, RealCard } from '../../../偶像大师闪耀色彩-gacha/types';
import { STARRY_NIGHT_POOL, POOL_STATS as STARRY_NIGHT_STATS } from '../../卡牌管理/pools/starry-night';

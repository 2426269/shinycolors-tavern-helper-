...
import type { GachaResult, GachaUserData } from '../../../偶像大师闪耀色彩-gacha/types';
import { preloadCommonSSRCards, preloadPickupCard } from '../../../偶像大师闪耀色彩-gacha/utils/image-preloader';
import { GACHA_COST } from '../../工具/constants';
import { loadUserData, resetUserData, saveUserData } from '../../工具/存储';
import { getAvailableCardPools, performSinglePullReal, performTenPullReal } from '../服务/抽卡核心';

...
export const ALL_EFFECTS: EffectData[] = [
  ...
  },
  {
    name: '好印象效果增加',
    nameJP: '好印象効果アップ',
    description: 'N回合内，好印象提供的得分增加N%（对应 GoodImpressionBonus）',
    belongTo: '理性',
    type: '正面',
  },
  {
    name: '干劲',
    nameJP: 'やる気',
    description: 'N层时，打出提供元气的技能卡时，额外获得N点元气（对应 Motivation）',
    belongTo: '理性',
    type: '正面',
  },
  {
    name: '消费体力减少',
    nameJP: '消費体力減少',
    description: '技能卡所需体力减为原来的50%（向上取整），每回合-1层（对应 StaminaReduction）',
    belongTo: '通用',
    type: '正面',
  },
  {
    name: '消费体力削减',
    nameJP: '消費体力削減',
    description: 'N层时，技能卡所需体力减少N点（最低为0）（对应 StaminaCut）',
    belongTo: '通用',
    type: '正面',
  },
  {
  ...
  },
  {
    name: '热意',
    nameJP: '熱意',
    description: '每点热意在打出卡牌时加到基础分数上（对应 Heat）',
    belongTo: '非凡',
    type: '正面',
  },
  {
    name: '全力值',
    nameJP: '全力',
    description: '积累全力值（最大10点），达到10时自动进入全力状态，消耗10点（对应 AllPower）',
    belongTo: '非凡',
    type: '正面',
  },
  {
    ...
    nameJP: '温存',
    description:
      '降低分数上升量和体力消耗。▼一阶段：得分×0.5，体力消耗×0.5，解除时热意+5、技能卡使用次数+1。▼二阶段：得分×0.25，体力消耗×0.25，解除时热意+8、元气+5、技能卡使用次数+1（对应 ConserveState）',
    belongTo: '非凡',
    type: '正面',
  },
  {
    name: '强气状态',
    nameJP: '強気',
    description: '▼一阶段：得分×2，体力消耗×2。▼二阶段：得分×2.5，体力消耗×3+1（对应 ResoluteState）',
    belongTo: '非凡',
    type: '正面',
  },
  {
    name: '全力状态',
    nameJP: '全力',
    description: '得分×3，技能卡使用次数+1。由全力值达到10触发，状态自动结束后返回普通状态（对应 AlloutState）',
    belongTo: '非凡',
    type: '正面',
  },
  {
    ...
    nameJP: 'のんびり',
    description:
      '分数上升量和消费体力减少100%。当该状态被解除时，元气+5，技能卡使用次数+1。变更为「强气」或被解除时，热意+10。变更为「全力」时，所有技能卡数值+10',
    belongTo: '非凡',
    type: '正面',
  },
  {
    name: '最终得分倍率',
    nameJP: 'パラメータ上昇',
    description: 'N层时，技能卡数值最终提升N%。此效果在所有其他数值增幅效果之后生效（对应 ScoreFinalMultiplier）',
    belongTo: '通用',
    type: '正面',
  },
  {
    name: '得分增加',
    nameJP: 'スコアボーナス',
    description: 'N层时，得分增加N%（对应 ScoreBonus）',
    belongTo: '通用',
    type: '正面',
  },

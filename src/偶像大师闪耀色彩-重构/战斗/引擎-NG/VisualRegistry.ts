...
const STANDARD_BUFF_VISUALS: Record<string, DynamicVisual> = {
  ...
  StaminaCut: {
    ...
    isDebuff: false,
    shortName: '体力消耗削减',
    description: '体力消耗减少固定值',
    iconUrl: 'https://283pro.site/shinycolors/游戏图标/消费体力削减.png',
  },
  StaminaIncrease: {
    key: 'StaminaIncrease',
    kind: 'buff',
    ...
    isDebuff: true,
    shortName: '体力消耗增加',
    description: '体力消耗增加100%',
    iconUrl: 'https://283pro.site/shinycolors/游戏图标/消费体力增加.png',
  },
  StaminaExtra: {
    key: 'StaminaExtra',
    kind: 'buff',
    ...
    isDebuff: true,
    shortName: '体力消耗追加',
    description: '体力消耗追加固定值',
    iconUrl: 'https://283pro.site/shinycolors/游戏图标/消费体力追加.png',
  },
  ScoreFinalMultiplier: {
    key: 'ScoreFinalMultiplier',
    kind: 'buff',
    symbol: '倍',
    color: '#673AB7',
    isDebuff: false,
    shortName: '最终得分倍率',
    description: '最终得分倍率提升',
    iconUrl: 'https://283pro.site/shinycolors/游戏图标/数值提升.png',
  },
  // ===== 新增: 通用得分加成 =====
  ScoreBonus: {
    key: 'ScoreBonus',
  ...
  GoodImpressionBonus: {
    key: 'GoodImpressionBonus',
    kind: 'buff',
    symbol: '♥',
    color: '#E91E63',
    isDebuff: false,
    shortName: '好印象强化',
    description: '好印象效果增加xx%',
    iconUrl: 'https://283pro.site/shinycolors/游戏图标/好印象强化.png',
  },
};

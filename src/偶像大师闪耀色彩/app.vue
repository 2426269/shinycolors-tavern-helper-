  ...
  <div class="idol-master-container">
    ...
    <div class="character-layer">
      <div class="character-container-center">
        <!-- 角色立绘 -->
        <div v-if="currentCharacter" class="character-sprite-center">
    ...
    <div class="home-button-container">
      ...
      <div v-if="showHomeMenu" class="home-menu">
        <div class="menu-header">
          <h3>选择角色</h3>
          <button class="menu-close" @click="showHomeMenu = false">
        ...
        <div class="character-list">
          ...
          >
            ...
            <div class="char-info">
              ...
              <span class="char-unit">{{ char.unit }}</span>
            </div>
            <i v-if="index === currentCharacterIndex" class="fas fa-check-circle active-icon"></i>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="settings-panel-body">
          ...
          <div class="settings-category">
            ...
            <div class="setting-row">
              ...
              <div class="setting-desc">清除资源、抽卡、设置等游戏数据（不含图片缓存）</div>
              <div class="setting-control-col">
                <button
            ...
            <div class="setting-row">
              ...
              <div class="setting-desc">清除游戏数据和图片缓存（完全重置）</div>
              <div class="setting-control-col">
                <button
                  class="dev-action-btn"
...
import GachaApp from '../偶像大师闪耀色彩-gacha/app.vue';
import IdolCollectionApp from '../偶像大师闪耀色彩-gacha/components/IdolCollection.vue';
import CharacterSelection from './components/CharacterSelection.vue';
import { CDN_BASE, RESOURCE_ICONS, TOAST_SUCCESS_DURATION_MS } from './constants';
...
// 背景图片URL - 使用 GitHub 图片资源
const backgroundImageUrl = ref(`${CDN_BASE}/背景图/283背景图/Sc_bk_283pro_2.png`);
...
// 当前角色的立绘URL
const characterImageUrl = computed(() => currentCharacter.value.imageUrl);
...
const devClearAllCache = async () => {
  ...
  try {
    // 清除游戏数据
    const { clearAllData } = await import('./utils/game-data');
    await clearAllData();

    // 清除图片缓存
    const imageCacheModule = await import('../偶像大师闪耀色彩-gacha/utils/image-cache');
...
const devUnlockAllCharacters = async () => {
  ...
  try {
    // 动态导入卡池数据
    const { ALL_CARDS } = await import('../偶像大师闪耀色彩-gacha/data/all-cards');
...
.idol-master-container {
  position: relative;
  width: 100%;
  aspect-ratio: 16 / 10; /* 从 16:9 改为 16:10，页面更高 */
